...
public class GaletteTransformer {
    ...
    // Exclude Green solver framework - not needed as it runs in external JVM via GreenServer
    // but keep it excluded in case fallback to in-process solver is attempted
    "za/ac/sun/cs/green/",
